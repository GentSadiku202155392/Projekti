          ...
          <section id="contact-section">
            ...
            <div>        
              <form>
                ...
                <input type="text" placeholder="Mbiemri"><br>
                <input type="Email" placeholder="Emaili" required><br>
              <textarea name="message" placeholder="Shkruani mesazhin tuaj!" rows="5" required></textarea><br>
                <button class="submit" >Dërgo Mesazhin</button> 
              </form>   
                </div>
              </div>
            </div>
